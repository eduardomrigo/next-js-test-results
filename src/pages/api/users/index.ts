 ...
 * 
 * 
 * Criei uma simples lista de usuario tipada de acordo com a interface IUser,
 * onde ha a verificacao do metodo GET, se for ele envia a lista de usuarios senao ele da o erro 405
 * 
 */
